...
import { buildSystemPrompt, getMinimalSystemPrompt } from './systemPrompt.js'
import type { AssembledContext, CrisisCheckResult, UserProfile, SessionState, SessionEntities } from '@recoverysky/types'
...
describe('buildSystemPrompt', () => {
  ...
  describe('user context section', () => {
    ...
    it('includes triggers', () => {
      const context = createMinimalContext()
      context.userProfile = createUserProfile({ triggers: ['stress', 'loneliness'] })
    ...
    it('includes coping strategies', () => {
      const context = createMinimalContext()
      context.userProfile = createUserProfile({ copingStrategies: ['walking', 'journaling'] })
