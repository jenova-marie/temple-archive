...
vi.mock('@jenova-marie/wonder-logger', () => ({
  ...
  createMemoryTransport: (...args: unknown[]) => mockCreateMemoryTransport(...args),
  createConsoleTransport: (...args: unknown[]) => mockCreateConsoleTransport(...args),
...
describe('observability/index', () => {
  let observability: typeof import('./index.js')
  ...
  beforeEach(async () => {
    ...
    observability = await import('./index.js')
  })
  ...
  describe('withSpan', () => {
    it('is exported and callable', async () => {
      const result = await observability.withSpan('test-span', async () => 'result')
