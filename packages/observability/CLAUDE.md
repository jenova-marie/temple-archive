...
This is `@recoverysky/observability`, a unified observability package for the RecoverySky Agent system. It wraps [wonder-logger](https://github.com/jenova-marie/wonder-logger) with project-specific defaults to provide:
...
- `@recoverysky/types` - Workspace package for `DomainError` type (dev dependency)
