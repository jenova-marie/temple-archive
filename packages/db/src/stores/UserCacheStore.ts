...
import type { UserProfile, StoreError, Result } from "@siri/types";
...
function serializeProfile(profile: UserProfile): Record<string, string> {
  return {
    ...
    recoveryDate: profile.recoveryDate ?? "",
