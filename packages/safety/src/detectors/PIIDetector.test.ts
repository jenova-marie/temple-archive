...
import { PIIDetector, type PIIMatch } from './PIIDetector.js'
...
describe('PIIDetector', () => {
  ...
  describe('detectViolations', () => {
    it('should return SafetyViolation format', async () => {
      ...
      const violations = await detector.detectViolations('SSN: 123-45-6789', ctx)
  ...
  describe('edge cases', () => {
    ...
    it('should handle string with no PII', () => {
      const matches = detector.detect('Just some regular text without any personal information')
      expect(matches).toHaveLength(0)
    })
