...
`@recoverysky/tools` provides AI tool definitions for the RecoverySky Agent, built with Vercel AI SDK. These tools enable the AI agent to:
...
**Dependencies:**
- `@recoverysky/observability` - For tracing (`withSpan`) and logging (`getLogger`)
- `@recoverysky/types` - Shared types
