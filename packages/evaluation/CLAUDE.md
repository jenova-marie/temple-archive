...
This is `@siri/evaluation`, a response quality evaluation package for the RecoverySky Agent system. It evaluates AI-generated responses for quality, relevance, empathy, and recovery-appropriateness.
...
**Dependencies**: Uses `@siri/types` for interfaces and `@siri/observability` for tracing/logging.

## Key Interfaces (from @siri/types)
